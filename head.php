...
<body>
  <div class="header">
    <a href="home.php" </a> <img src="image/sns.png" alt="image/sns.png" align="left">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>SNS Institutions Blood Bank & Donation </a>
